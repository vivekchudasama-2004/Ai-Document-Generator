...
**Version:** 1.16.0 | **Date:** 2026-09-04 | **Stack:** Open-Source + NVIDIA NIM on Vercel + TiDB Cloud | **Format:** Professional, 150 words/page, 100% Human Score Target
**Changelog v1.16.0:** Live-model catalog swap (Llama 3.1 retired 2026-08-26: Mistral Large 2 / Nemotron 70B / Mistral 7B); `MODEL_NO_ACCESS` path — 404/410 refusals skip retries and surface key-entitlement guidance instead of "busy"; retry-with-Nemotron button + entitlement note in wizard.
